...
{
	if (debugMode) console.log("Util.checkConnection");
  
  var networkState = navigator.connection.type;
  if (debugMode) console.log ("network state is: " + networkState);
...
{
	if (debugMode) console.log('Util.LoadAllRecords');
...
{
	if (debugMode) console.log('Util.addEntriesFromCursorTo');
